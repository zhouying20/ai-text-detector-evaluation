...
import detect.lib_sim.pairing as pairing
import detect.lib_sim.utils as utils
...
from detect.lib_sim.evaluate_sts import evaluate_sts
...
def load_model(path, gpu=1, sp_model="dipper_paraphrases/sim/paranmt.model"):
    ...
    if model_args.model == "avg":
        ...
        model = LSTM(None, model_args, vocab, vocab_fr)
