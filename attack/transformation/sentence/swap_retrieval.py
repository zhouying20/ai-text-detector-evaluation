...
__all__ = ['RetrievalReplacementSentence']
...
class RetrievalReplacementSentence(Transformation):
    r"""
    ...
    def __init__(
        ...
        trans_max=1,
        max_gen_len=32,
        retrieval_method="facebook/bart-base",
        seed=42,
        device=None,
        **kwargs
    ):
    ...
    def __repr__(self):
        return 'RetrievalReplacementSentence'
    ...
    def _bart_mask_generate(self, contexts, prefixes, left_parts, right_parts, n=1):
